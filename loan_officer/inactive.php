...
// Fetch only Inactive & Pending customers for this officer
...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    switch (strtolower($row['status'])) {
        ...
        case 'inactive':
            ...
            break;
        case 'blacklisted':
            $row['status_color'] = 'bg-red-100 text-red-700';
            break;
        default:
...
<div class="w-full p-6 mt-4 bg-white rounded-2xl shadow-lg">
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Inactive Customers</h1>
  </div>
