...
$loan_officer_id = $_SESSION['admin']['id']; // logged-in officer
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO loans 
        (customer_id, product_id, principal_amount, interest_rate, duration_weeks, weekly_installment, total_repayable, loan_code, status, created_at, branch_id, officer_id) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'Pending', NOW(), ?, ?)"
    );
