...
<head>
  <meta charset="UTF-8">
  <title>Disbursed Loans – Faida SACCO</title>
...
<body class="bg-gray-100 p-6 font-sans">
  <div class="w-full px-4 sm:px-6 lg:px-8 py-6 bg-white rounded shadow-md">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold brand">Disbursed Loans</h1>
    ...
    <div class="flex flex-wrap items-center gap-4 mb-4">
      ...
      <select id="statusFilter" onchange="filterLoans()" class="px-3 py-2 border rounded">
        ...
        <option value="Disbursed" selected>Disbursed</option>
        ...
        <tbody id="loanTableBody">
          <?php
            $query = mysqli_query($conn, "
              ...
              WHERE loans.status IN ('Disbursed','Active')
              GROUP BY loans.id
  ...
  <script>
    ...
    function exportToPDF() {
      ...
      const opt = {
        margin: 0.3,
        filename: 'disbursed_loans_list.pdf',
